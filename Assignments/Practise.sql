...
SELECT from_date as original, DATE_FORMAT(from_date, "%M %d, %Y") as formatted FROM salaries; 
...
select * from employees where first_name LIKE 'Elv%' and last_name NOT LIKE '_e%';
